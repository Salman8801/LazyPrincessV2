...
# Others
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001628897659'))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'Moviesbank_Corporation')
...
DOWNLOAD_TEXT_URL = "https://t.me/Moviesbank_Corporation/101"
